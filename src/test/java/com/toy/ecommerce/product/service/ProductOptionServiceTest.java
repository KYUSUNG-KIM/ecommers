...
class ProductOptionServiceTest {
    ...
    void create() {
        ...
        given(productService.getBySellerIdAndProductCode(anyLong(), anyString())).willReturn(mock(Product.class));
    ...
    void checkPurchasable_true() {
        ...
        ProductOption mockProductOption = setProductOption(mockForm.getOptionCode(), SellStatus.ON_SALE, 999);
    ...
    void checkPurchasable_false() {
        ...
        List<CheckOptionForm> mockForms = List.of(mockForm);
        ProductOption mockProductOption = setProductOption(mockForm.getOptionCode(), SellStatus.ON_SALE, 1);
        given(productOptionRepository.findByOptionCodeAndSellStatus(anyString(), any(SellStatus.class)))
                .willReturn(Optional.of(mockProductOption));
